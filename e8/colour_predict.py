...
# python3 colour_predict.py colour-data.csv
...
def main():
    ...
    rf_rgb_model = RandomForestClassifier(n_estimators=500, min_samples_leaf=5)
    rf_rgb_model.fit(X_train, y_train)
    rf_convert_model = make_pipeline(FunctionTransformer(rgb2lab),RandomForestClassifier(n_estimators=500, max_depth=80, min_samples_leaf=5))
