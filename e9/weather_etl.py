import sys
from pyspark.sql import SparkSession, functions, types, Row, column
...
def main(in_directory, out_directory):
    ...
    cleaned_data = cleaned_data.withColumn("tmax", cleaned_data['value'] / 10).select("station", "date", "tmax")
